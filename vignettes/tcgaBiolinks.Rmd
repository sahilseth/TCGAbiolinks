...
```{r, eval = FALSE}
acc.muse.maf <- GDCquery_maf(project = "TCGA-CHOL", pipelines = "muse")
...
acc.mutect.maf <- GDCquery_maf("TCGA-CHOL", pipelines = "mutect")
```
...
mut <- GDCquery_maf("TCGA-CHOL", pipelines = "mutect2")
...
```{r,eval=FALSE,echo=TRUE,message=FALSE,warning=FALSE}
LGGmut <- GDCquery_maf(project = "TCGA-LGG", pipelines = "muse")
# Selecting gene
mRNAsel <- "ATRX"
